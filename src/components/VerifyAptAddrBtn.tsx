...
export default function VerifyEthAddrBtn({
  addrInfo,
  addrIndex,
  address,
  verified,
  ...
  const render_button = () => {
    if (address) {
      // only render if address exists
      if (verified) {
        // if verified already, disable button input
        return (
          <>
            <td>
              <button
        ...
        // if not verified
        if (signature !== "") {
          // if signature is filled, enable verification button
          return (
            <>
              <td>
                <button
          ...
          // if signature is not filled, enable generate signature button
          return (
            <>
              <td>
                <button
